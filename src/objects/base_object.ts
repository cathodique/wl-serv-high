...
const StatifiedObjRef = $.makeStatified(ObjectReference);
export class BaseObject<T extends Record<string, any[]> | [never] = Record<string, any[]> | [never]> extends StatifiedObjRef<T> {
  process() {}
